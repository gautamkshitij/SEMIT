...
public class Environment {
    ...
    public Environment(String fullname, String fullpath, long id, String shortname)
   	{
    ...
    public Environment withFullname(String fullname) {
        this.fullname = fullname;
        return this;
    }
    ...
    public Environment withFullpath(String fullpath) {
        this.fullpath = fullpath;
        return this;
    }
    ...
    public Environment withShortname(String shortname) {
        this.shortname = shortname;
        return this;
    }
